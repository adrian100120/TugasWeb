...
if (isset($_POST['update'])){
    $pdo -> hasil_booking($id_cafe, $_SESSION['name'], $date, $_POST['meja'], 'true', 'false');
...
<style>
    ...
    <meta name="author" content=""/>
      <title>Booking (Smoking Room) - e-Nongki</title>
    ...
    <div class="container">
        ...
        <img src="<?= $smoking ?>" alt="" width="900rem;"><br><br><br>
    ...
    <section class="page-section bg-primary text-white text-center">
        <div class="container">
            ...
            <p><b>Ruangan :</b><br> Ruang asap rokok (Smoking room)</p>
