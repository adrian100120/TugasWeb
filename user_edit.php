...
<!-- Awal Interface edit profile -->
<!DOCTYPE HTML>
<html>
<style>
  body{
        background-image : url("gambar/background_editusers.jpg");
...
<!-- Optional JavaScript -->
    ...
    <body>
      ...
      <form method="POST">
          ...
          <div class="form-group">
            <button class="btn btn-primary" name="submit" style="margin:15px;">Update</button>
            </form>
